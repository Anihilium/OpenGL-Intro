...
namespace LowRenderer
{
    ...
    void Camera::UpdateVectors()
    {
        ...
        mRight = Front.CrossProduct(mWorldUp).Normalize();  // normalize the vectors, because their length gets closer to 0 the more you look up or down which results in slower movement.
        mUp = mRight.CrossProduct(Front).Normalize();
    }
	...
	{        
        ...
        if (CamInputs.moveLeft)
            Position -= mRight * mSpeed * deltaTime;
